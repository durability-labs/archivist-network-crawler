...
##    conflicts](https://github.com/archivist-storage/nim-archivist/pull/645#issuecomment-1838834467)
##
## When declaring a new type, one should consider importing the `archivist/logutils`
